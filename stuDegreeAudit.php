...
<tbody>
<!--SELECT * 
FROM major_req AS mr 
LEFT JOIN academicrecord AS ar 
  ON ar.CourseID = mr.course_id 
 AND ar.UserEmail = '".$_SESSION["username"]."'
LEFT JOIN course AS c 
  ON c.CourseID = mr.course_id 
LEFT JOIN department AS d 
  ON d.DeptID = c.DeptID 
LEFT JOIN subject AS s 
  ON s.subject_id = c.subject_id 
WHERE ar.CourseID IS NULL*/-->
...
$sql = "SELECT * FROM enrolled AS e
        ...
        WHERE e.UserEmail='".$_SESSION["username"]."' AND sy.current='1'";
...
$sql = "SELECT * FROM academicrecord AS ar
        ...
        WHERE ar.UserEmail='".$_SESSION["username"]."'";
