...
<div class="container">
    ...
    <form class="form-inline" action="adminStuAddSectionDB.php" method="post">
        <h3 class="text-center">Select student and input CRN of course you wish to register them for</h3>
        <div class="row">
            <div class="col-sm-3 col-sm-offset-5">
                <div class="form-group">
                    <label for="cname">Student:</label>
